####Calculating sparseness for the four maps types - saliency maps (actual and resized) and three conspicuity maps
...
#Consider: Which value to properly display the many_peak/few_peak (in Matlab)?